...
struct2geno(file = "Washingtonia_test_samples.recode.p.structure", TESS = FALSE, diploid = TRUE, FORMAT = 2,extra.row = 0, extra.col = 0, output = "/home/rstudio/Wash.geno")


#test for best K
obj.snmf = snmf("/home/rstudio/Wash.geno", K = 1:25,  ploidy = 2, entropy = T, alpha = 100, project = "new")
pdf(file="/home/rstudio/delta_K.pdf")
...
### K = 2
##########
obj.snmf = snmf("/home/rstudio/Wash.geno", K = 2, alpha = 100, project = "new", iterations=500)
...
pdf(file="/home/rstudio/K_equals_2.pdf",10,5)
...
## K = 3
#######
obj.snmf = snmf("/home/rstudio/Wash.geno", K = 3, alpha = 100, project = "new", iterations=500)
qmatrix = Q(obj.snmf, K = 3)
palette4 <- c("#FFFB23","#FF9326","#DF0101")
names <- c("NACA14","NACA16","NACA18","CACA11","CACA17","CACA18","COMO11","COMO14","COMO18","MULE16","MULE19","MULE20","ROFO12","ROFO16","ROFO17","SJD11","SJD19","SJD20","BERRE12","BERRE15","BERRE19","BOCA14","BOCA19","BOCA20","BOR13","BOR14","BOR18","CATA1","CATA5","CATA9","STAMA12","STAMA19","STAMA20","JOSH14","JOSH18","JOSH19","KOFA12","KOFA13","KOFA18","PALM11","PALM17","PALM18","PALO13","PALO16","PALO20","ALA13","ALA15","ALA18")
#plot classic structure diagram
pdf(file="/home/rstudio/K_equals_3.pdf",10,5)
barplot(t(qmatrix), col = c(palette4), border = NA, space = 0,names.arg=names,las=2,cex.names=0.7,
        xlab = "Individuals", ylab = "Admixture coefficients")
dev.off()
...
obj.snmf = snmf("/home/rstudio/Wash.geno", K = 4, alpha = 100, project = "new", iterations=500)
qmatrix = Q(obj.snmf, K = 4)
palette4 <- c("#FF9326","#DF0101","#FFFB23","#A945FF")
names <- c("NACA14","NACA16","NACA18","CACA11","CACA17","CACA18","COMO11","COMO14","COMO18","MULE16","MULE19","MULE20","ROFO12","ROFO16","ROFO17","SJD11","SJD19","SJD20","BERRE12","BERRE15","BERRE19","BOCA14","BOCA19","BOCA20","BOR13","BOR14","BOR18","CATA1","CATA5","CATA9","STAMA12","STAMA19","STAMA20","JOSH14","JOSH18","JOSH19","KOFA12","KOFA13","KOFA18","PALM11","PALM17","PALM18","PALO13","PALO16","PALO20","ALA13","ALA15","ALA18")
#plot classic structure diagram
pdf(file="/home/rstudio/K_equals_4.pdf",7,3)
barplot(t(qmatrix), col = c(palette4), border = NA, space = 0,names.arg=names,las=2,cex.names=0.7,
        xlab = "Individuals", ylab = "Admixture coefficients")
dev.off()
...
# K = 5
#####
obj.snmf = snmf("/home/rstudio/Wash.geno", K = 5, alpha = 100, project = "new", iterations=500)
qmatrix = Q(obj.snmf, K = 5)

palette5 <- c("#A945FF","#FFFB23","#FF9326","#DF0101","#9999FF")
names <- c("NACA14","NACA16","NACA18","CACA11","CACA17","CACA18","COMO11","COMO14","COMO18","MULE16","MULE19","MULE20","ROFO12","ROFO16","ROFO17","SJD11","SJD19","SJD20","BERRE12","BERRE15","BERRE19","BOCA14","BOCA19","BOCA20","BOR13","BOR14","BOR18","CATA1","CATA5","CATA9","STAMA12","STAMA19","STAMA20","JOSH14","JOSH18","JOSH19","KOFA12","KOFA13","KOFA18","PALM11","PALM17","PALM18","PALO13","PALO16","PALO20","ALA13","ALA15","ALA18")
#plot classic structure diagram
pdf(file="/home/rstudio/K_equals_5.pdf",10,5)
...
# K = 6
#####
obj.snmf = snmf("/home/rstudio/Wash.geno", K = 6, alpha = 100, project = "new", iterations=500)
qmatrix = Q(obj.snmf, K = 6)

palette6 <- c("#FF9326","#A945FF","#FFFB23","#9999FF","#04B404","#DF0101")
names <- c("NACA14","NACA16","NACA18","CACA11","CACA17","CACA18","COMO11","COMO14","COMO18","MULE16","MULE19","MULE20","ROFO12","ROFO16","ROFO17","SJD11","SJD19","SJD20","BERRE12","BERRE15","BERRE19","BOCA14","BOCA19","BOCA20","BOR13","BOR14","BOR18","CATA1","CATA5","CATA9","STAMA12","STAMA19","STAMA20","JOSH14","JOSH18","JOSH19","KOFA12","KOFA13","KOFA18","PALM11","PALM17","PALM18","PALO13","PALO16","PALO20","ALA13","ALA15","ALA18")
#plot classic structure diagram
pdf(file="/home/rstudio/K_equals_6.pdf",10,5)
...
# K = 7
#####
obj.snmf = snmf("/home/rstudio/Wash.geno", K = 7, alpha = 100, project = "new", iterations=500)
...
names <- c("NACA14","NACA16","NACA18","CACA11","CACA17","CACA18","COMO11","COMO14","COMO18","MULE16","MULE19","MULE20","ROFO12","ROFO16","ROFO17","SJD11","SJD19","SJD20","BERRE12","BERRE15","BERRE19","BOCA14","BOCA19","BOCA20","BOR13","BOR14","BOR18","CATA1","CATA5","CATA9","STAMA12","STAMA19","STAMA20","JOSH14","JOSH18","JOSH19","KOFA12","KOFA13","KOFA18","PALM11","PALM17","PALM18","PALO13","PALO16","PALO20","ALA13","ALA15","ALA18")
#plot classic structure diagram
pdf(file="/home/rstudio/K_equals_7.pdf",10,5)
...
# K = 8
#####
obj.snmf = snmf("/home/rstudio/Wash.geno", K = 8, alpha = 100, project = "new", iterations=500)
...
names <- c("NACA14","NACA16","NACA18","CACA11","CACA17","CACA18","COMO11","COMO14","COMO18","MULE16","MULE19","MULE20","ROFO12","ROFO16","ROFO17","SJD11","SJD19","SJD20","BERRE12","BERRE15","BERRE19","BOCA14","BOCA19","BOCA20","BOR13","BOR14","BOR18","CATA1","CATA5","CATA9","STAMA12","STAMA19","STAMA20","JOSH14","JOSH18","JOSH19","KOFA12","KOFA13","KOFA18","PALM11","PALM17","PALM18","PALO13","PALO16","PALO20","ALA13","ALA15","ALA18")
#plot classic structure diagram
pdf(file="/home/rstudio/K_equals_8.pdf",10,5)
